...
class EmailPreprocessor:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.warning(f"⚠️  NLTK initialization failed: {e}. Using fallback stopwords.")
    ...
    def tokenize(self, text: str) -> List[str]:
        ...
        try:
            ...
            logger.warning(f"⚠️  NLTK tokenization failed: {e}. Using split()")
    ...
    def preprocess_email(self, email_content: str, return_steps: bool = False) -> Dict[str, Any]:
        ...
        if not email_content or not isinstance(email_content, str):
            logger.warning("⚠️  Empty or invalid email content provided")
            return {
